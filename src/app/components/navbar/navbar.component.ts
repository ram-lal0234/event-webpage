...
@Component({
  ...
  template: `
    <nav [class.shadow-md]="isScrolled" class="fixed w-full bg-white z-50 transition-all duration-300">
      <div class="container">
        <div class="flex items-center justify-between h-16">
          <a routerLink="/" class="text-2xl font-bold text-primary-600">EventPro</a>
